...
#figure(image("../../assets/images/10_the-three-reforms_illustration.jpg", width: 92.0%))
...
#figure(image("../../assets/images/10_the-three-reforms_infographic.png", width: 100.0%))
...
paper #strong[Chapter 10: What To Do]. That paper states the
three-reform program directly and grounds it in the documented upstream
record on platform design, training conflict, access control, and
institutional capture.

Scan this QR code to open the live research paper with the full
documentary basis, citations, and supporting links.

#figure(image("../../assets/qrcodes/10_the-three-reforms_research_qr.svg", width: 34.0%))

Fallback URL:
#link("https://hassanvfx.github.io/ai-empire/papers/html/10_three-reform-program_paper.html")[hassanvfx.github.io/ai-empire/papers/html/10\_three-reform-program\_paper.html]
