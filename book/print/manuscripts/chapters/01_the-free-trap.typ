...
#figure(image("../../assets/images/01_the-free-trap_illustration.jpg", width: 92.0%))
...
about but definitely cared about. Your friends say, "just text me," but
the culture has already been routed elsewhere. The feed is not merely
where people waste time. It is where time got socially organized. That
is why refusal can feel weirdly aristocratic, like only people with
...
#figure(image("../../assets/images/01_the-free-trap_infographic.png", width: 100.0%))
...
paper #strong[Chapter 01: Social Networks as Infrastructure for Free
Data Capture]. That paper grounds the case in the FTC record,
Facebook/Meta governance history, and the platform business model of
