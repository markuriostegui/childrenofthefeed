...
#figure(image("../../assets/images/04_we-were-the-dataset_illustration.jpg", width: 92.0%))
...
between "nobody owns this" and "a small number of firms get to own this
completely." If frontier capability is built from humanity's collective
archive, then treating the result as ordinary private property by
default starts to look less like innovation and more like enclosure.

#figure(image("../../assets/images/04_we-were-the-dataset_infographic.png", width: 100.0%))
...
paper #strong[Chapter 04: AI Arrives When the Human Raw Material Already
Exists]. That paper grounds the weights debate in Copyright Office
records, memorization research, licensing developments, court conflict,
