...
#figure(image("../../assets/images/02_raised-by-the-algorithm_illustration.jpg", width: 92.0%))
...
#figure(image("../../assets/images/02_raised-by-the-algorithm_infographic.png", width: 100.0%))
...
frameworks. A lot of adults still want to talk about "bad influences" as
if the problem were mainly a set of wrong examples floating through
...
moderation discourse. "Better content policy" does not begin to meet the
scale of what is being described here. The problem is not just a bad
...
paper #strong[Chapter 02: Social Erosion and Moral Reconfiguration].
