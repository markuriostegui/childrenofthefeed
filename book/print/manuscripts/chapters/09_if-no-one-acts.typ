...
#figure(image("../../assets/images/09_if-no-one-acts_illustration.jpg", width: 92.0%))
...
#figure(image("../../assets/images/09_if-no-one-acts_infographic.png", width: 100.0%))
...
paper #strong[Chapter 09: Future if No Action Is Taken]. That paper
turns the upstream record into a bounded continuity scenario rather than
a sensational apocalypse narrative.
