...
#figure(image("../../assets/images/00_before-the-machine-could-speak_illustration.jpg", width: 92.0%))
...
#figure(image("../../assets/images/00_before-the-machine-could-speak_infographic.png", width: 100.0%))
...
paper #strong[Chapter 00: Opening Framework]. That paper connects the
weights question, the enclosure of human value, the congressional uptake
of the argument, and the three-reform destination of the wider dossier.
