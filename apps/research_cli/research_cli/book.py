...
def render_book_landing_html(root: Path, interactive_app_href: str, spanish_pdf_href: str | None = None) -> str:
    ...
    return "\n".join(
        [
            ...
            "    .print-edition-card { border-color: rgba(255, 83, 66, 0.82); background: radial-gradient(circle at top right, rgba(255, 83, 66, 0.48), transparent 52%), linear-gradient(145deg, rgba(89, 12, 18, 0.98), rgba(33, 8, 14, 0.96)); box-shadow: 0 22px 58px rgba(119, 10, 20, 0.46), inset 0 1px 0 rgba(255,255,255,0.12); }",
            "    .print-edition-card .experience-heading { color: #fff1eb; text-shadow: 0 0 18px rgba(255, 92, 73, 0.38); }",
            "    .print-edition-card .experience-button { color: #fffaf5; background: linear-gradient(135deg, #ff5a49, #c9202d); border-color: rgba(255, 196, 184, 0.82); box-shadow: 0 10px 24px rgba(88, 7, 15, 0.38), inset 0 1px 0 rgba(255,255,255,0.26); }",
            "    .print-edition-card .experience-button:hover { background: linear-gradient(135deg, #ff705e, #df2937); border-color: #fff0ea; }",
            "    .print-edition-card .experience-icon { background: rgba(68, 5, 11, 0.42); color: #fff0bf; }",
            ...
            '          <a class="experience-button" href="pdf/full_book/full_book.pdf"><span class="experience-icon" aria-hidden="true">download</span><span class="experience-label">Download eBook</span></a>',
            # *([
            ...
            "        </div>",
            "      </section>",
            "      <section class=\"experience-card print-edition-card\" aria-label=\"Share your support\">",
            "        <h2 class=\"experience-heading\">Share your Support</h2>",
            "        <div class=\"experience-actions\">",
            '          <a class="experience-button" href="https://www.lulu.com/shop/hassan-uriostegui/children-of-the-feed-servants-of-the-ai-god/paperback/product-kvgzw9n.html?page=1&amp;pageSize=4"><span class="experience-icon" aria-hidden="true">menu_book</span><span class="experience-label">Purchase the Book</span></a>',
